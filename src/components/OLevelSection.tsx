...
function SubjectCard({ name, slug, code }: { name: string; slug: string; code: string }) {
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-2xl bg-white border border-ink-10 hover:shadow-[0_8px_30px_rgba(14,31,75,0.10)] focus-within:ring-2 ${theme.ring} focus-within:ring-offset-2 focus-within:ring-offset-sky`}
    >
