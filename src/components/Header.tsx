    ...
    <header className="sticky top-0 z-50 bg-void px-4 pt-4 pb-0 relative">
      ...
      <div className="mx-auto flex max-w-5xl items-center justify-between rounded-full border border-glass-border bg-white/5 px-4 py-2.5 backdrop-blur-2xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/contact"
            className="hidden rounded-full bg-yellow px-4 py-1.5 text-sm font-bold text-ink transition-all hover:bg-[#F5C518] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow focus-visible:ring-offset-2 focus-visible:ring-offset-void sm:block"
          >
            Register Now
          </Link>
