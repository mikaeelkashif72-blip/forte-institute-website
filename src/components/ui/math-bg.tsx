...
const ROWS: [number, number, 1 | -1, number[], number][] = [
  [6,   38, 1,  [0, 4, 8,  12], 0.09],
  [16,  52, -1, [1, 5, 9,  13], 0.07],
  [26,  44, 1,  [2, 6, 10, 14], 0.08],
  [38,  60, -1, [3, 7, 11,  0], 0.06],
  [50,  34, 1,  [4, 8, 12,  1], 0.09],
  [62,  48, -1, [5, 9, 13,  2], 0.07],
  [74,  56, 1,  [6, 10, 14, 3], 0.07],
  [86,  40, -1, [7, 11, 0,  4], 0.08],
];
