...
const ROWS: [number, number, 1 | -1, number[], number][] = [
  [6,   120, 1,  [0, 4, 8,  12], 0.09],
  [16,  160, -1, [1, 5, 9,  13], 0.07],
  [26,  140, 1,  [2, 6, 10, 14], 0.08],
  [38,  180, -1, [3, 7, 11,  0], 0.06],
  [50,  110, 1,  [4, 8, 12,  1], 0.09],
  [62,  150, -1, [5, 9, 13,  2], 0.07],
  [74,  170, 1,  [6, 10, 14, 3], 0.07],
  [86,  130, -1, [7, 11, 0,  4], 0.08],
];
